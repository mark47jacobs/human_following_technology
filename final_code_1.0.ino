...
void setup()
{
  ...
  setRobotPosition();//first...the position of the robot is set....
...
void turnRight()
{
  ...
  digitalWrite(RightMotorBackward, LOW);delay(100);
}
...
void turnLeft()
{
  ...
  digitalWrite(LeftMotorBackward, LOW);delay(100);
}
...
{     
      ...
      {     if(distance1 >=30 && distance1 < 50)
            {     moveForward();delay(100);     }

            else if(distance1 <30 && distance1 >17)
